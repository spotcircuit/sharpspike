...
import { Loader2, Play, Pause, Eye } from 'lucide-react';
                      ...
                      <TableRow key={job.id} className={`${statusColor.bg} hover:bg-opacity-30`}>
                        ...
                        <TableCell className="w-36">
                          <Progress 
                            ...
                            // Use the status color for the progress bar
                            style={{ "--progress-color": statusColor.dot } as any}
                          />
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            <Button
                              size="sm"
                              variant="outline"
                              onClick={() => handleViewTrackData(job.track_name)}
                              className="h-7 px-2 text-xs"
                            >
